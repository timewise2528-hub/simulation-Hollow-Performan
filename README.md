# HOLLOW INTELLIGENCE: HOW ARTIFICIAL INTELLIGENCE CREATES HUMAN INCOMPETENCE 
...
- [HOLLOW INTELLIGENCE: HOW ARTIFICIAL INTELLIGENCE CREATES HUMAN INCOMPETENCE](#hollow-intelligence-how-artificial-intelligence-creates-human-incompetence)
  ...
  - [Key Phenomena](#key-phenomena)
    ...
    - [Domain‑Specific Collapse Thresholds (Simplified Model)](#domainspecific-collapse-thresholds-simplified-model)
  ...
  - [Mathematical Models \& Code Mapping](#mathematical-models--code-mapping)
    ...
    - [First‑Principles Dynamic Model](#firstprinciples-dynamic-model)
  - [Repository Structure](#repository-structure)
    - [`requirements.txt` note](#requirementstxt-note)
...
scipy>=1.7
seaborn>=0.11
pillow>=9.0    # required for GIF animation (matplotlib.animation)
...
- **Python**: 3.8+  
- **Hardware**: Any modern CPU; runs in seconds.  
- **OS**: Cross‑platform.  
- **Reproducibility**: Fixed seed (`42`), results are deterministic.  
- **No internet** needed after install.  
- All code is in the notebook; copy to `.py` to run standalone.  
